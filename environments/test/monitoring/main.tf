...
module "activity_log_alert" {
  ...
  name                = "alert-ealz-test-admin-changes"
  resource_group_name = data.azurerm_resource_group.rg.name
...
module "storage_account_metric_alert" {
  ...
  name                = "alert-ealz-test-storage-capacity"
  resource_group_name = data.azurerm_resource_group.rg.name
...
module "acr_metric_alert" {
  ...
  name                = "alert-ealz-test-acr-requests"
  resource_group_name = data.azurerm_resource_group.rg.name
...
module "key_vault_metric_alert" {
  ...
  name                = "alert-ealz-test-keyvault-requests"
  resource_group_name = data.azurerm_resource_group.rg.name
...
module "key_vault_diagnostic_policy_assignment" {
  ...
  name = "assign-ealz-test-kv-diagnostics"
...
module "storage_account_diagnostic_policy_assignment" {
  ...
  name = "assign-ealz-test-storage-diagnostics"
...
module "acr_diagnostic_policy_assignment" {
  ...
  name = "assign-ealz-test-acr-diagnostics"
...
module "compute_vm_availability_metric_alert" {
  ...
  name                = "alert-ealz-test-vm-availability"
  resource_group_name = data.azurerm_resource_group.rg.name
...
module "vmss_availability_metric_alert" {
  ...
  name                = "alert-ealz-test-vmss-availability"
  resource_group_name = data.azurerm_resource_group.rg.name
...
module "linux_vm_memory_alert" {
  ...
  name                = "alert-ealz-test-linux-memory"
  resource_group_name = data.azurerm_resource_group.rg.name
  location            = var.location
...
module "windows_vm_memory_alert" {
  ...
  name                = "alert-ealz-test-windows-memory"
  resource_group_name = data.azurerm_resource_group.rg.name
  location            = var.location
...
module "linux_vm_disk_alert" {
  ...
  name                = "alert-ealz-test-linux-disk"
  resource_group_name = data.azurerm_resource_group.rg.name
  location            = var.location
...
module "windows_vm_disk_alert" {
  ...
  name                = "alert-ealz-test-windows-disk"
  resource_group_name = data.azurerm_resource_group.rg.name
  location            = var.location
